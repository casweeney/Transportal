                ...
                <div class="row">
                    ...
                    <div class="col-md-4">                        
                        <div style="border-radius: 0;" class="card" id="signup_card">
                            <br>
                            <h4 class="text-center text-info"><a style="color: #aaa;" href="index.php"><i class='fa fa-home'></i></a> Sign in <img id="loading" src="img/loading.gif" style="width: 10%; margin-top: -3%; display: none;" alt=""></h4>
                            <span class="response text-center"></span>
                            <div class="card-body">
                                <form action="signin_processor.php" method="post" id="signinForm">
